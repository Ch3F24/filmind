(() => {
  ...
  // ns-params:@params
  var token = "IGQWRNeEk1b2tOWmQyLVJGOEhrUWdCX0w0TFZAERlNlVnVKNjdWMEhXRF96U0FnaTBieG1MLWpjTjVSenpQVmtNdl94ZAnlLbC1tUjNmMWxmN3NXenBHVVdRUDV6UnpLaV8xV2ZAScXZAqMVlFQkRLS3ZALcE1vdmJoblEZD";
  ...
  // <stdin>
  var url = "https://graph.instagram.com/me/media?fields=caption,media_url,permalink&limit=12&access_token=";
  var grid = document.querySelector(".instagrid");
  async function fetch() {
    return axios_default.get(url + token);
  }
  async function init() {
    let data;
    if (alreadyFetched()) {
